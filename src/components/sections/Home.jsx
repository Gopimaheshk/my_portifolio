    ...
    className="h-screen flex items-center justify-center relative">
      <div className="text-center z-10 px-4">
        ...
        <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
          I am a full-stack developer who loves building web applications 
          that are not only functional but also visually appealing. 
          With a passion for coding and a keen eye for design,
           I strive to create seamless user experiences.
        </p>
